...
export const THEMES = {
  india: {
    ...
    backgrounds: [
      ...
      {
        url: "https://images.unsplash.com/photo-1506461883276-594a12b11cf3?auto=format&fit=crop&w=1920&q=80",
        alt: "Tea plantations",
      },
      {
        url: "https://images.unsplash.com/photo-1585136917228-959814df0792?auto=format&fit=crop&w=1920&q=80",
        alt: "Rice terraces India",
      },
    ],
    audio: {
      tracks: [
        {
          name: "Lunar New Year",
          url: "assets/audio/lunar_new_year.mp3",
          duration: 180,
        },
        {
          name: "Meditation Music",
          url: "assets/audio/meditation-yoga-relaxing-music.mp3",
          duration: 300,
        },
        {
          name: "River & Birds",
          url: "assets/audio/river_and_birds.mp3",
          duration: 60,
        },
        {
          name: "Surf, Waves and Sea Foam",
          url: "assets/audio/surf-waves-and-sea-foam.mp3",
          duration: 63,
        },
        {
          name: "Brilliance",
          url: "assets/audio/brilliance.mp3",
          duration: 153,
        },
        {
          name: "Native American Flute",
          url: "assets/audio/native-american-style-flute-in-a.mp3",
          duration: 82,
        },
      ],
    },
  ...
  japan: {
    ...
    backgrounds: [
      {
        url: "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=1920&q=80&blur=50",
        alt: "Zen garden",
      },
      {
        url: "https://images.unsplash.com/photo-1528360983277-13d401cdc186?auto=format&fit=crop&w=1920&q=80&blur=50",
        alt: "Bamboo forest",
      },
      {
        url: "https://images.unsplash.com/photo-1490806843957-31f4c9a91c65?auto=format&fit=crop&w=1920&q=80&blur=50",
        alt: "Cherry blossoms",
      },
      {
        url: "https://images.unsplash.com/photo-1545569341-9eb8b30979d9?auto=format&fit=crop&w=1920&q=80&blur=50",
        alt: "Mount Fuji",
      },
    ],
    audio: {
  ...
  celtic: {
    ...
    backgrounds: [
      {
        url: "https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?auto=format&fit=crop&w=1920&q=80&blur=50",
        alt: "Misty forest path",
      },
      {
        url: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&w=1920&q=80&blur=50",
        alt: "Forest light",
      },
      {
        url: "https://images.unsplash.com/photo-1519904981063-b0cf448d479e?auto=format&fit=crop&w=1920&q=80&blur=50",
        alt: "Emerald forest",
      },
      {
        url: "https://images.unsplash.com/photo-1426604966848-d7adac402bff?auto=format&fit=crop&w=1920&q=80&blur=50",
        alt: "Mountain lake",
      },
    ],
    audio: {
    ...
    backgrounds: [
      {
        ...
        alt: "Desert road landscape",
      },
      {
        url: "https://images.unsplash.com/photo-1519904981063-b0cf448d479e?auto=format&fit=crop&w=1920&q=80&blur=50",
        alt: "Desert grassland",
      },
      {
